...
# ⚠️ 重要: main と同じ HEAD SHA だと Vercel の "Ignored Build Step: automatic"
# が「既にビルド済み」と判定して preview deployment を作らない。
# 独自コミットを 1 つ足して SHA を分岐させる:
git checkout preview-test
git commit --allow-empty -m "chore: preview-test branch marker"
