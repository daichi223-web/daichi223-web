...
## 要本文確認ケース (text 自体が古典文法に不整合)

| 教材 | sentence/token | text | 現状 | 問題 |
|---|---|---|---|---|
| 鷲にさらわれた赤子 (9e0911918f) | s1-t78 / s26-t11 | 悲しむ + で | マ四連用形タグ | 古典「悲しみて」、撥音便「悲しんで」のいずれでもなく「悲しむで」と表記。`originalText` 自体に同形が含まれるため token-text 整合性は OK だが、典拠 (今昔物語集巻29 第31 など) で実際にこの綴りなのかは別途確認要 |
