...
const FIXES = [
  ...
  // ここから M2（他の教材と食い違う）で根拠が立ったもの
  { title: '倭建命', word: '子', from: 'こ', to: '', why: '「御子たち」の「子」。ラベル欄に読みが紛れ込んでいる。他22例は空' },
  { title: '落窪の君', word: '人', from: 'ひと', to: '', why: 'ラベル欄に読みが紛れ込んでいる。他267例は空' },
  { title: '賀茂の祭りを見物する翁', word: '多く', from: 'ク用', to: 'ク・用', why: '区切りの中黒が抜けている。他17例は「ク・用」' },
  { title: '道綱鷹を放つ', word: 'いみじう', from: 'シク・用', to: 'シク・用（ウ音）', why: '「いみじう」はウ音便。他38例はすべて「シク・用（ウ音）」' },
  { title: '暁の雪', word: '久しく', from: 'ク・用', to: 'シク・用', why: '「久し」はシク活用。他11例はすべて「シク・用」' },
  { title: '狩りの使ひ', word: 'よみ', from: 'ラ四・用', to: 'マ四・用', why: '「詠む」はマ行四段。他16例はすべて「マ四・用」' },
];
